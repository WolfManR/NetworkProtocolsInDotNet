...
namespace LibraryServiceReference
{
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.3")]
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="LibraryServiceReference.BooksWebCatalogSoap")]
    public interface BooksWebCatalogSoap
    {
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.3")]
    public interface BooksWebCatalogSoapChannel : LibraryServiceReference.BooksWebCatalogSoap, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.3")]
    public partial class BooksWebCatalogSoapClient : System.ServiceModel.ClientBase<LibraryServiceReference.BooksWebCatalogSoap>, LibraryServiceReference.BooksWebCatalogSoap
    {
        ...
        public BooksWebCatalogSoapClient(EndpointConfiguration endpointConfiguration) : 
                base(BooksWebCatalogSoapClient.GetBindingForEndpoint(endpointConfiguration), BooksWebCatalogSoapClient.GetEndpointAddress(endpointConfiguration))
        {
            this.Endpoint.Name = endpointConfiguration.ToString();
            ConfigureEndpoint(this.Endpoint, this.ClientCredentials);
        }
        
        public BooksWebCatalogSoapClient(EndpointConfiguration endpointConfiguration, string remoteAddress) : 
                base(BooksWebCatalogSoapClient.GetBindingForEndpoint(endpointConfiguration), new System.ServiceModel.EndpointAddress(remoteAddress))
        {
            this.Endpoint.Name = endpointConfiguration.ToString();
            ConfigureEndpoint(this.Endpoint, this.ClientCredentials);
        }
        
        public BooksWebCatalogSoapClient(EndpointConfiguration endpointConfiguration, System.ServiceModel.EndpointAddress remoteAddress) : 
                base(BooksWebCatalogSoapClient.GetBindingForEndpoint(endpointConfiguration), remoteAddress)
        {
            this.Endpoint.Name = endpointConfiguration.ToString();
            ConfigureEndpoint(this.Endpoint, this.ClientCredentials);
        }
        
        public BooksWebCatalogSoapClient(System.ServiceModel.Channels.Binding binding, System.ServiceModel.EndpointAddress remoteAddress) : 
                base(binding, remoteAddress)
        {
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        LibraryServiceReference.GetBooksByTitleResponse LibraryServiceReference.BooksWebCatalogSoap.GetBooksByTitle(LibraryServiceReference.GetBooksByTitleRequest request)
        {
        ...
        public LibraryServiceReference.Book[] GetBooksByTitle(string title)
        {
            ...
            LibraryServiceReference.GetBooksByTitleResponse retVal = ((LibraryServiceReference.BooksWebCatalogSoap)(this)).GetBooksByTitle(inValue);
            return retVal.Body.GetBooksByTitleResult;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<LibraryServiceReference.GetBooksByTitleResponse> LibraryServiceReference.BooksWebCatalogSoap.GetBooksByTitleAsync(LibraryServiceReference.GetBooksByTitleRequest request)
        {
        ...
        public System.Threading.Tasks.Task<LibraryServiceReference.GetBooksByTitleResponse> GetBooksByTitleAsync(string title)
        {
            ...
            inValue.Body = new LibraryServiceReference.GetBooksByTitleRequestBody();
            inValue.Body.title = title;
            return ((LibraryServiceReference.BooksWebCatalogSoap)(this)).GetBooksByTitleAsync(inValue);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        LibraryServiceReference.GetBooksByAuthorResponse LibraryServiceReference.BooksWebCatalogSoap.GetBooksByAuthor(LibraryServiceReference.GetBooksByAuthorRequest request)
        {
        ...
        public LibraryServiceReference.Book[] GetBooksByAuthor(string authorName)
        {
            ...
            LibraryServiceReference.GetBooksByAuthorResponse retVal = ((LibraryServiceReference.BooksWebCatalogSoap)(this)).GetBooksByAuthor(inValue);
            return retVal.Body.GetBooksByAuthorResult;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<LibraryServiceReference.GetBooksByAuthorResponse> LibraryServiceReference.BooksWebCatalogSoap.GetBooksByAuthorAsync(LibraryServiceReference.GetBooksByAuthorRequest request)
        {
        ...
        public System.Threading.Tasks.Task<LibraryServiceReference.GetBooksByAuthorResponse> GetBooksByAuthorAsync(string authorName)
        {
            ...
            inValue.Body = new LibraryServiceReference.GetBooksByAuthorRequestBody();
            inValue.Body.authorName = authorName;
            return ((LibraryServiceReference.BooksWebCatalogSoap)(this)).GetBooksByAuthorAsync(inValue);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        LibraryServiceReference.GetBooksByCategoryResponse LibraryServiceReference.BooksWebCatalogSoap.GetBooksByCategory(LibraryServiceReference.GetBooksByCategoryRequest request)
        {
        ...
        public LibraryServiceReference.Book[] GetBooksByCategory(string category)
        {
            ...
            LibraryServiceReference.GetBooksByCategoryResponse retVal = ((LibraryServiceReference.BooksWebCatalogSoap)(this)).GetBooksByCategory(inValue);
            return retVal.Body.GetBooksByCategoryResult;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<LibraryServiceReference.GetBooksByCategoryResponse> LibraryServiceReference.BooksWebCatalogSoap.GetBooksByCategoryAsync(LibraryServiceReference.GetBooksByCategoryRequest request)
        {
        ...
        public System.Threading.Tasks.Task<LibraryServiceReference.GetBooksByCategoryResponse> GetBooksByCategoryAsync(string category)
        {
            ...
            inValue.Body = new LibraryServiceReference.GetBooksByCategoryRequestBody();
            inValue.Body.category = category;
            return ((LibraryServiceReference.BooksWebCatalogSoap)(this)).GetBooksByCategoryAsync(inValue);
        }
        ...
        {
            if ((endpointConfiguration == EndpointConfiguration.BooksWebCatalogSoap))
            {
            ...
            if ((endpointConfiguration == EndpointConfiguration.BooksWebCatalogSoap12))
            {
        ...
        private static System.ServiceModel.EndpointAddress GetEndpointAddress(EndpointConfiguration endpointConfiguration)
        {
            if ((endpointConfiguration == EndpointConfiguration.BooksWebCatalogSoap))
            {
                return new System.ServiceModel.EndpointAddress("http://localhost:63843/BooksWebCatalog.asmx");
            }
            if ((endpointConfiguration == EndpointConfiguration.BooksWebCatalogSoap12))
            {
                return new System.ServiceModel.EndpointAddress("http://localhost:63843/BooksWebCatalog.asmx");
